...
//					model name	 				group			 	category						size					maxfuel	fuelcons	lootindex	trunksize	spawnchance	flags
	...
	DefineVehicleType(520, "Hydra",				vgroup_Military,	VEHICLE_CATEGORY_PLANE,			VEHICLE_SIZE_LARGE,		7790.0,		333.9,	-1,						0,		0.78);
	DefineVehicleType(432, "Rhino",				vgroup_Military,	VEHICLE_CATEGORY_TRUCK,			VEHICLE_SIZE_LARGE,		1900.0,		392.0,	loot_CarMilitary,		8,		0.92);

...
{
	d:3:GLOBAL_DEBUG("[OnPlayerUseItemWithItem] in /gamemodes/sss/core/item/stungun.pwn");
...
{
	d:3:GLOBAL_DEBUG("[OnItemNameRender] in /gamemodes/sss/core/item/stungun.pwn");

...
hook OnGameModeInit()
{
	print("\n[OnGameModeInit] Initialising 'bowlerhat'...");

	new tmp;

	tmp = DefineHatItem(item_BowlerHat);
	...
	SetHatOffsetsForSkin(tmp, skin_Civ3M, 0.123000, 0.002999, -0.001000,  0.123000, 0.002999, -0.001000,  1.000000, 1.075001, 0.945000);
	SetHatOffsetsForSkin(tmp, skin_Civ4M, 0.137000, 0.010000, -0.005000,  0.137000, 0.010000, -0.005000,  1.000000, 1.075001, 1.062000);

...
DestroyTree(index)
{
    ...
    tree_Data[index][tree_objectid] = INVALID_STREAMER_ID;
    tree_Data[index][tree_areaid]   = INVALID_STREAMER_ID;
    tree_Data[index][tree_labelid]  = Text3D:INVALID_STREAMER_ID;
...
{
	_tree_EnterArea(playerid, areaid);

	#if defined tree_OnPlayerEnterDynamicArea
		return tree_OnPlayerEnterDynamicArea(playerid, areaid);
	#else
		return 1;
	#endif
}
...
#define OnPlayerEnterDynamicArea tree_OnPlayerEnterDynamicArea
#if defined tree_OnPlayerEnterDynamicArea
	forward tree_OnPlayerEnterDynamicArea(playerid, areaid);
#endif

public OnPlayerLeaveDynamicArea(playerid, areaid)
{
	_tree_LeaveArea(playerid, areaid);

	#if defined tree_OnPlayerLeaveDynamicArea
		return tree_OnPlayerLeaveDynamicArea(playerid, areaid);
	#else
		return 1;
	#endif
}
...
#define OnPlayerLeaveDynamicArea tree_OnPlayerLeaveDynamicArea
#if defined tree_OnPlayerLeaveDynamicArea
	forward tree_OnPlayerLeaveDynamicArea(playerid, areaid);
#endif

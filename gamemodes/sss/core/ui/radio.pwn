...
hook OnPlayerConnect(playerid)
{
	...
	PlayerTextDrawAlignment			(playerid, RadioUI_Main[playerid], TEXT_DRAW_ALIGN_CENTRE);
	PlayerTextDrawBackgroundColour	(playerid, RadioUI_Main[playerid], 255);
	PlayerTextDrawFont				(playerid, RadioUI_Main[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, RadioUI_Main[playerid], 0.500000, 1.499999);
	PlayerTextDrawColour				(playerid, RadioUI_Main[playerid], -1);
	...
	PlayerTextDrawBoxColour			(playerid, RadioUI_Main[playerid], 100);
	...
	PlayerTextDrawAlignment			(playerid, RadioUI_Strip[playerid], TEXT_DRAW_ALIGN_CENTRE);
	PlayerTextDrawBackgroundColour	(playerid, RadioUI_Strip[playerid], 255);
	PlayerTextDrawFont				(playerid, RadioUI_Strip[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, RadioUI_Strip[playerid], 0.300000, 1.000000);
	PlayerTextDrawColour				(playerid, RadioUI_Strip[playerid], -1);
	...
	PlayerTextDrawBackgroundColour	(playerid, RadioUI_KnobL[playerid], 255);
	PlayerTextDrawFont				(playerid, RadioUI_KnobL[playerid], TEXT_DRAW_FONT_SPRITE_DRAW);
	PlayerTextDrawLetterSize		(playerid, RadioUI_KnobL[playerid], 0.500000, 1.000000);
	PlayerTextDrawColour				(playerid, RadioUI_KnobL[playerid], 0x780000FA);
	...
	PlayerTextDrawBoxColour			(playerid, RadioUI_KnobL[playerid], 255);
	...
	PlayerTextDrawBackgroundColour	(playerid, RadioUI_KnobR[playerid], 255);
	PlayerTextDrawFont				(playerid, RadioUI_KnobR[playerid], TEXT_DRAW_FONT_SPRITE_DRAW);
	PlayerTextDrawLetterSize		(playerid, RadioUI_KnobR[playerid], 0.500000, 1.000000);
	PlayerTextDrawColour				(playerid, RadioUI_KnobR[playerid], 0x780000FA);
	...
	PlayerTextDrawBoxColour			(playerid, RadioUI_KnobR[playerid], 255);
	...
	PlayerTextDrawAlignment			(playerid, RadioUI_Mode[playerid], TEXT_DRAW_ALIGN_CENTRE);
	PlayerTextDrawBackgroundColour	(playerid, RadioUI_Mode[playerid], 255);
	PlayerTextDrawFont				(playerid, RadioUI_Mode[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, RadioUI_Mode[playerid], 0.300000, 1.499999);
	PlayerTextDrawColour				(playerid, RadioUI_Mode[playerid], 16777215);
	...
	PlayerTextDrawBoxColour			(playerid, RadioUI_Mode[playerid], 255);
	...
	PlayerTextDrawAlignment			(playerid, RadioUI_Freq[playerid], TEXT_DRAW_ALIGN_CENTRE);
	PlayerTextDrawBackgroundColour	(playerid, RadioUI_Freq[playerid], 255);
	PlayerTextDrawFont				(playerid, RadioUI_Freq[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, RadioUI_Freq[playerid], 0.300000, 1.499999);
	PlayerTextDrawColour				(playerid, RadioUI_Freq[playerid], 16777215);
	...
	PlayerTextDrawBoxColour			(playerid, RadioUI_Freq[playerid], 255);
	...
	PlayerTextDrawAlignment			(playerid, RadioUI_Power[playerid], TEXT_DRAW_ALIGN_CENTRE);
	PlayerTextDrawBackgroundColour	(playerid, RadioUI_Power[playerid], 255);
	PlayerTextDrawFont				(playerid, RadioUI_Power[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, RadioUI_Power[playerid], 0.400000, 1.499999);
	PlayerTextDrawColour				(playerid, RadioUI_Power[playerid], -16776961);
	...
	PlayerTextDrawBoxColour			(playerid, RadioUI_Power[playerid], 255);
	...
	PlayerTextDrawAlignment			(playerid, RadioUI_Back[playerid], TEXT_DRAW_ALIGN_CENTRE);
	PlayerTextDrawBackgroundColour	(playerid, RadioUI_Back[playerid], 255);
	PlayerTextDrawFont				(playerid, RadioUI_Back[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, RadioUI_Back[playerid], 0.300000, 1.499999);
	PlayerTextDrawColour				(playerid, RadioUI_Back[playerid], -1);
	...
	PlayerTextDrawBoxColour			(playerid, RadioUI_Back[playerid], 100);

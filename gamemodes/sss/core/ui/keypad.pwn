...
kp_LoadUI(playerid)
{
	...
	PlayerTextDrawAlignment			(playerid, kp_Background[playerid], TEXT_DRAW_ALIGN_CENTRE);
	PlayerTextDrawBackgroundColour	(playerid, kp_Background[playerid], -1);
	PlayerTextDrawFont				(playerid, kp_Background[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, kp_Background[playerid], 0.500000, 16.199998);
	PlayerTextDrawColour				(playerid, kp_Background[playerid], 255);
	...
	PlayerTextDrawBoxColour			(playerid, kp_Background[playerid], 80);
	...
	PlayerTextDrawBackgroundColour	(playerid, kp_EdgeL[playerid], -1);
	PlayerTextDrawFont				(playerid, kp_EdgeL[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, kp_EdgeL[playerid], 0.500000, -1.100000);
	PlayerTextDrawColour				(playerid, kp_EdgeL[playerid], 255);
	...
	PlayerTextDrawBoxColour			(playerid, kp_EdgeL[playerid], -2021161081);
	...
	PlayerTextDrawBackgroundColour	(playerid, kp_EdgeT[playerid], -1);
	PlayerTextDrawFont				(playerid, kp_EdgeT[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, kp_EdgeT[playerid], 0.500000, 16.199998);
	PlayerTextDrawColour				(playerid, kp_EdgeT[playerid], 255);
	...
	PlayerTextDrawBoxColour			(playerid, kp_EdgeT[playerid], -2021161081);
	...
	PlayerTextDrawBackgroundColour	(playerid, kp_EdgeB[playerid], -1);
	PlayerTextDrawFont				(playerid, kp_EdgeB[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, kp_EdgeB[playerid], 0.500000, -1.100000);
	PlayerTextDrawColour				(playerid, kp_EdgeB[playerid], 255);
	...
	PlayerTextDrawBoxColour			(playerid, kp_EdgeB[playerid], -2021161081);
	...
	PlayerTextDrawBackgroundColour	(playerid, kp_EdgeR[playerid], -1);
	PlayerTextDrawFont				(playerid, kp_EdgeR[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, kp_EdgeR[playerid], 0.500000, 16.800001);
	PlayerTextDrawColour				(playerid, kp_EdgeR[playerid], 255);
	...
	PlayerTextDrawBoxColour			(playerid, kp_EdgeR[playerid], -2021161081);
	...
	PlayerTextDrawAlignment			(playerid, kp_KeyEnter[playerid], TEXT_DRAW_ALIGN_CENTRE);
	PlayerTextDrawBackgroundColour	(playerid, kp_KeyEnter[playerid], -1);
	PlayerTextDrawFont				(playerid, kp_KeyEnter[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, kp_KeyEnter[playerid], 0.500000, 2.000000);
	PlayerTextDrawColour				(playerid, kp_KeyEnter[playerid], 255);
	...
	PlayerTextDrawBoxColour			(playerid, kp_KeyEnter[playerid], 538976384);
	...
	PlayerTextDrawAlignment			(playerid, kp_KeyCancel[playerid], TEXT_DRAW_ALIGN_CENTRE);
	PlayerTextDrawBackgroundColour	(playerid, kp_KeyCancel[playerid], -1);
	PlayerTextDrawFont				(playerid, kp_KeyCancel[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, kp_KeyCancel[playerid], 0.500000, 2.000000);
	PlayerTextDrawColour				(playerid, kp_KeyCancel[playerid], 255);
	...
	PlayerTextDrawBoxColour			(playerid, kp_KeyCancel[playerid], 538976384);
	...
	PlayerTextDrawAlignment			(playerid, kp_Key0[playerid], TEXT_DRAW_ALIGN_CENTRE);
	PlayerTextDrawBackgroundColour	(playerid, kp_Key0[playerid], -1);
	PlayerTextDrawFont				(playerid, kp_Key0[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, kp_Key0[playerid], 0.500000, 2.000000);
	PlayerTextDrawColour				(playerid, kp_Key0[playerid], 255);
	...
	PlayerTextDrawBoxColour			(playerid, kp_Key0[playerid], 538976384);
	...
	PlayerTextDrawAlignment			(playerid, kp_Key1[playerid], TEXT_DRAW_ALIGN_CENTRE);
	PlayerTextDrawBackgroundColour	(playerid, kp_Key1[playerid], -1);
	PlayerTextDrawFont				(playerid, kp_Key1[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, kp_Key1[playerid], 0.500000, 2.000000);
	PlayerTextDrawColour				(playerid, kp_Key1[playerid], 255);
	...
	PlayerTextDrawBoxColour			(playerid, kp_Key1[playerid], 538976384);
	...
	PlayerTextDrawAlignment			(playerid, kp_Key2[playerid], TEXT_DRAW_ALIGN_CENTRE);
	PlayerTextDrawBackgroundColour	(playerid, kp_Key2[playerid], -1);
	PlayerTextDrawFont				(playerid, kp_Key2[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, kp_Key2[playerid], 0.500000, 2.000000);
	PlayerTextDrawColour				(playerid, kp_Key2[playerid], 255);
	...
	PlayerTextDrawBoxColour			(playerid, kp_Key2[playerid], 538976384);
	...
	PlayerTextDrawAlignment			(playerid, kp_Key3[playerid], TEXT_DRAW_ALIGN_CENTRE);
	PlayerTextDrawBackgroundColour	(playerid, kp_Key3[playerid], -1);
	PlayerTextDrawFont				(playerid, kp_Key3[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, kp_Key3[playerid], 0.500000, 2.000000);
	PlayerTextDrawColour				(playerid, kp_Key3[playerid], 255);
	...
	PlayerTextDrawBoxColour			(playerid, kp_Key3[playerid], 538976384);
	...
	PlayerTextDrawAlignment			(playerid, kp_Key4[playerid], TEXT_DRAW_ALIGN_CENTRE);
	PlayerTextDrawBackgroundColour	(playerid, kp_Key4[playerid], -1);
	PlayerTextDrawFont				(playerid, kp_Key4[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, kp_Key4[playerid], 0.500000, 2.000000);
	PlayerTextDrawColour				(playerid, kp_Key4[playerid], 255);
	...
	PlayerTextDrawBoxColour			(playerid, kp_Key4[playerid], 538976384);
	...
	PlayerTextDrawAlignment			(playerid, kp_Key5[playerid], TEXT_DRAW_ALIGN_CENTRE);
	PlayerTextDrawBackgroundColour	(playerid, kp_Key5[playerid], -1);
	PlayerTextDrawFont				(playerid, kp_Key5[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, kp_Key5[playerid], 0.500000, 2.000000);
	PlayerTextDrawColour				(playerid, kp_Key5[playerid], 255);
	...
	PlayerTextDrawBoxColour			(playerid, kp_Key5[playerid], 538976384);
	...
	PlayerTextDrawAlignment			(playerid, kp_Key6[playerid], TEXT_DRAW_ALIGN_CENTRE);
	PlayerTextDrawBackgroundColour	(playerid, kp_Key6[playerid], -1);
	PlayerTextDrawFont				(playerid, kp_Key6[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, kp_Key6[playerid], 0.500000, 2.000000);
	PlayerTextDrawColour				(playerid, kp_Key6[playerid], 255);
	...
	PlayerTextDrawBoxColour			(playerid, kp_Key6[playerid], 538976384);
	...
	PlayerTextDrawAlignment			(playerid, kp_Key7[playerid], TEXT_DRAW_ALIGN_CENTRE);
	PlayerTextDrawBackgroundColour	(playerid, kp_Key7[playerid], -1);
	PlayerTextDrawFont				(playerid, kp_Key7[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, kp_Key7[playerid], 0.500000, 2.000000);
	PlayerTextDrawColour				(playerid, kp_Key7[playerid], 255);
	...
	PlayerTextDrawBoxColour			(playerid, kp_Key7[playerid], 538976384);
	...
	PlayerTextDrawAlignment			(playerid, kp_Key8[playerid], TEXT_DRAW_ALIGN_CENTRE);
	PlayerTextDrawBackgroundColour	(playerid, kp_Key8[playerid], -1);
	PlayerTextDrawFont				(playerid, kp_Key8[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, kp_Key8[playerid], 0.500000, 2.000000);
	PlayerTextDrawColour				(playerid, kp_Key8[playerid], 255);
	...
	PlayerTextDrawBoxColour			(playerid, kp_Key8[playerid], 538976384);
	...
	PlayerTextDrawAlignment			(playerid, kp_Key9[playerid], TEXT_DRAW_ALIGN_CENTRE);
	PlayerTextDrawBackgroundColour	(playerid, kp_Key9[playerid], -1);
	PlayerTextDrawFont				(playerid, kp_Key9[playerid], TEXT_DRAW_FONT_1);
	PlayerTextDrawLetterSize		(playerid, kp_Key9[playerid], 0.500000, 2.000000);
	PlayerTextDrawColour				(playerid, kp_Key9[playerid], 255);
	...
	PlayerTextDrawBoxColour			(playerid, kp_Key9[playerid], 538976384);
	...
	PlayerTextDrawAlignment			(playerid, kp_Display[playerid], TEXT_DRAW_ALIGN_CENTRE);
	PlayerTextDrawBackgroundColour	(playerid, kp_Display[playerid], -1);
	PlayerTextDrawFont				(playerid, kp_Display[playerid], TEXT_DRAW_FONT_2);
	PlayerTextDrawLetterSize		(playerid, kp_Display[playerid], 0.500000, 2.000000);
	PlayerTextDrawColour				(playerid, kp_Display[playerid], -65281);
	...
	PlayerTextDrawBoxColour			(playerid, kp_Display[playerid], 255);

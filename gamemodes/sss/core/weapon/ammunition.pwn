...
{
	d:3:GLOBAL_DEBUG("[OnItemNameRender] in /gamemodes/sss/core/weapon/ammunition.pwn");
...
{
	d:3:GLOBAL_DEBUG("[OnItemCreate] in /gamemodes/sss/core/weapon/ammunition.pwn");

...
_mbt_CreateRoom_0(instworld)
{
	...
	CreateStaticLootSpawn(-7.3336, -9.7528, 21.2515, loot_Survivor, 100.0, 6, mbd_Data[instworld][mbd_worldid], 1);
}
...
public OnMultiButtonTrigger(triggerid, success)
{
	_mbd_trigger(triggerid, success);

	#if defined mbd_OnMultiButtonTrigger
		return mbd_OnMultiButtonTrigger(triggerid, success);
	#else
		return 1;
	#endif
}
#if defined _ALS_OnMultiButtonTrigger
	#undef OnMultiButtonTrigger
#else
	#define _ALS_OnMultiButtonTrigger
#endif
 
#define OnMultiButtonTrigger mbd_OnMultiButtonTrigger
#if defined mbd_OnMultiButtonTrigger
	forward mbd_OnMultiButtonTrigger(triggerid, success);
#endif
...
public OnButtonPress(playerid, buttonid)
{
	...
	#if defined mbd_OnButtonPress
		return mbd_OnButtonPress(playerid, buttonid);
	#else
		return 0;
	#endif
}
...
#define OnButtonPress mbd_OnButtonPress
#if defined mbd_OnButtonPress
	forward mbd_OnButtonPress(playerid, buttonid);
#endif

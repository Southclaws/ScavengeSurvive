...
new Float:water_squares[][] = {{-1584.0, -1826.0, -1360.0, -1642.0, 0.00000},
...
new Float:water_triangles[][] = {{-912.0, 208.0, -724.0, 208.0, -912.0, 20.0, 0.00000},
...
for(new i = 0; i < sizeof water_triangles; i++) { // Check the triangle zones too.
	if(z <= water_triangles[i][6]) {
		if(water_triangles[i][0] > x || water_triangles[i][2] < x) continue;  // Is within X boundaries
		if(water_triangles[i][1] > water_triangles[i][5]) {                   // Is within Y boundaries check.
			if(water_triangles[i][5] > y || water_triangles[i][1] < y) continue;
		} else if(water_triangles[i][1] > y || water_triangles[i][5] < y) continue;

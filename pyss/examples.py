...
def main():
	...
	print("Loaded", len(vehicle_spawns.vehicles), "vehicles from server 'vspawn' directory")

	print("Loaded", len(object_set.objects), "object sets from server 'maps' directory")

	print("Loaded", len(loot_spawns.spawns), "loot spawn sets from server 'maps' directory")

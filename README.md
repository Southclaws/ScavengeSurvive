...
For the original readme.md please visit Southclaw's repository.

This fork referes to the gamemode that is currently being run by me at *gameserver.scavengesurvive.com:7777*

It will still contain all the updates released by Southclaw with minor edits and Whitetiger's anti-cheat embed into the gamemode (this obviously will not be public).